...
<ul className="space-y-4 text-left text-gray-500 dark:text-gray-400">
    <li className="flex items-center space-x-3 rtl:space-x-reverse">
         <svg className="flex-shrink-0 w-3.5 h-3.5 text-gradient1 dark:text-gradient1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 12">
    ...
    <li className="flex items-center space-x-3 rtl:space-x-reverse">
        ...
        <span>Registration Fee: <span className="font-semibold text-gray-900 ">₹700 per Team</span></span>
    </li>
