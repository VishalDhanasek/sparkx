  ...
  return (
    <footer>
      ...
      <div className="w-full text-7xl font-bold mb-5">
                <h4 className="text-2xl md:text-4xl font-extrabold leading-tighter tracking-tighter w-full md:w-2/3">Crafted With ❤️️ By <br></br> <span className="text-4xl md:text-5xl font-extrabold bg-clip-text text-transparent bg-[linear-gradient(to_right,theme(colors.indigo.400),theme(colors.indigo.100),theme(colors.sky.400),theme(colors.fuchsia.400),theme(colors.sky.400),theme(colors.indigo.100),theme(colors.indigo.400))] bg-[length:200%_auto] animate-gradient">Innovation Geeks</span></h4>
            </div>
      ...
      <img className=" opacity-[0.09]" src="/f1.png" >
          ...
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
            ...
            <ul className="text-sm">
              <li className="mb-2">
                <a href="#" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Volunteer</a>
              </li>
              <li className="mb-2">
                <a href="#" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Sponsorship</a>
              </li>
            </ul>
          </div>
          ...
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
            ...
            <ul className="text-sm">
              <li className="mb-2">
                <a href="#" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Code of Conduct</a>
              </li>
              <li className="mb-2">
                <a href="#" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Privacy Policy</a>
              </li>
              <li className="mb-2">
                <a href="#" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Terms and Conditions</a>
              </li>
        ...
        <div className="md:flex md:items-center md:justify-between py-4 md:py-8 ">
          ...
          {/* Copyrights note */}
          <div className="text-sm font-semibold text-gray-600 mr-4">&copy; SparkX. All rights reserved.</div>
