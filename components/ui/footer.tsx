      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="sm:col-span-12 lg:col-span-3">
            ...
            <div className="text-sm">
              <h5 className="text-gray-600 ">
                "Empowering Innovation, Igniting Collaboration"{" "}
              </h5>
            </div>
          </div>
        ...
        <div className="md:flex md:items-center md:justify-between py-4 md:py-8 ">
          ...
          <ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
            <li>
              <a
                href="https://www.linkedin.com/groups/14390165/"
            ...
            <li className="ml-4">
              <a
                href="https://www.youtube.com/@SparkX2024"
                className="flex justify-center items-center text-gray-600 hover:text-gray-900 bg-white hover:bg-white-100 rounded-full shadow transition duration-150 ease-in-out"
                aria-label="Youtube"
                target="_blank"
              >
            ...
            <li className="ml-4">
              <a
                href="https://www.instagram.com/sparkx_2024/?hl=en"
                className="flex justify-center items-center text-gray-600 hover:text-gray-900 bg-white hover:bg-white-100 rounded-full shadow transition duration-150 ease-in-out"
          ...
          <div className="text-sm font-semibold text-gray-600 mr-4">
            &copy; SparkX. All rights reserved.
          </div>
        </div>
      </div>
    </footer>
