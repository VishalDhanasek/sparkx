export default function Bento() {
  ...
  <h3 className="h3 mt-4  p-4 md:p-8  text-white">36 Hrs <br></br>non-stop Hackathon</h3>
...
<img src="/stopwatch1.png" width="480" height="83" alt="Logos"/>
  ...
  <div className="bg-gradient-to-r from-gradient1 to-gradient2 p-4 md:p-8 rounded-3xl">
    <div className="mb-4">
    <h2 className="h3 mt-4 mb-4 text-white">5 Lakhs Prize Pool <br></br>& exiting Goodies</h2>
    <div className="justify-center " >
<img src="/gift.png" width="480" height="83" alt="Logos"/>
        ...
        <h2 className="h3 mt-4 mb-4 text-white">Backed by StartUp TN<br></br>& DreamTamilNadu </h2>
        <div className="justify-center " >
