...
export default function Themes() {
	...
	<img className="object-cover w-[540px] h-[300px] brightness-50 transform transition duration-300 hover:scale-110" src="https://images.unsplash.com/photo-1598074824604-7a162d2b5db4?q=80&w=1790&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Flower and sky"/>
  ...
  <div className="relative overflow-hidden rounded-2xl shadow-2xl cursor-pointer transform-hidden h-[300px]">
	<img className="object-cover w-[540px] h-[300px] brightness-50 transform transition duration-300 hover:scale-110" src="https://images.unsplash.com/photo-1532012197267-da84d127e765?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8ZWR1Y2F0aW9ufGVufDB8fDB8fHwy" alt="Flower and sky"/>
  ...
  <div className="relative overflow-hidden rounded-2xl shadow-2xl cursor-pointer transform-hidden h-[300px]">
	<img className="object-cover w-[540px] h-[300px] brightness-50 transform transition duration-300 hover:scale-110" src="https://images.unsplash.com/photo-1556742502-ec7c0e9f34b1?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8cGhvbmUlMjBwYXl8ZW58MHwxfDB8fHwy" alt="Flower and sky"/>
  ...
  <div className="relative overflow-hidden rounded-2xl shadow-2xl cursor-pointer transform-hidden h-[300px]">
	<img className="object-cover w-[540px] h-[300px] brightness-50 transform transition duration-300 hover:scale-110" src="https://images.unsplash.com/photo-1619697101606-7c092a8e6281?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1yZWxhdGVkfDd8fHxlbnwwfHx8fHw%3D" alt="Flower and sky"/>
